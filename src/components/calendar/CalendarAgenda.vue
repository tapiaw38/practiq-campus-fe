<script setup lang="ts">
  ...
  function attendeeName(id: string) { return courseEnrollments.value.find((item) => item.user_id === id)?.user_name || "(sin nombre)"; }
