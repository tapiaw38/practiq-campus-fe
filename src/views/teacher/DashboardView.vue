...
<style scoped>
  ...
  @media(max-width:700px){
    ...
    .course-grid{grid-template-columns:1fr;gap:var(--space-2)}.course-card{padding:var(--space-3)}.course-list .course-card{grid-template-columns:auto minmax(0,1fr);row-gap:var(--space-2)}.course-list .course-main{grid-column:1/-1;grid-row:2}.course-list .course-actions{grid-column:1/-1;grid-row:3;width:100%;min-width:0}.course-list .course-actions-secondary{max-width:100%;flex-wrap:wrap;justify-content:flex-end}.course-list .course-open{min-width:0}.course-list .delete-course{margin-left:auto}
  }
</style>
