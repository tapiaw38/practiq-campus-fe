...
<style scoped>
  ...
  @media(max-width:700px){.dashboard-head{align-items:stretch;flex-direction:column;padding:var(--space-5)}.new-course-btn{justify-content:center}.summary-grid{grid-template-columns:1fr}.courses-heading{align-items:flex-start;flex-direction:column}.courses-tools{width:100%;justify-content:space-between}.course-list .course-card{grid-template-columns:auto minmax(0,1fr);row-gap:var(--space-2)}.course-list .course-main{grid-column:1/-1;grid-row:2}.course-list .course-actions{grid-column:1/-1;grid-row:3;width:100%;min-width:0}.course-list .course-actions-secondary{max-width:100%;flex-wrap:wrap;justify-content:flex-end}.course-list .course-open{min-width:0}.course-list .delete-course{margin-left:auto}}
</style>
