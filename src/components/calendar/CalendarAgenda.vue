...
<template>
  <div class="calendar-agenda">
    ...
    <section v-else class="calendar-card" aria-label="Calendario mensual">
...
<style scoped>
  .calendar-agenda { max-width: 960px; }
  ...
  .day-cell { min-height:110px; padding:var(--space-2);border-top:1px solid var(--surface-border); border-right:1px solid var(--surface-border); overflow:hidden; }.day-cell:nth-child(7n){border-right:0}.day-cell--muted{background:var(--surface-ground)}
